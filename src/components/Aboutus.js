        ...
        <Row>
          <Col sm={12} md={6} lg={6} className="order-1  order-md-0">
            <div className="px-3  px-md-none">
              ...
              >
                Hello! I'm <span className="text-danger">Kunal</span>, a
                aspiring Full stack developer based in Jalgaon, India.
              </p>
              <p
                ref={(el) => {
                  p2 = el;
              ...
              <ul className="list text-muted">
                <li className="bd">Backend :)</li>
                <li className="bd">Frontend :)</li>
                <li>MongoDB</li>
                <li>HTML</li>
                <li>Express Js</li>
                <li>CSS</li>
